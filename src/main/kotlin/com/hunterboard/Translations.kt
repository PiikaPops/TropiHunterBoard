...
object Translations {
    ...
    private val FR = mapOf(
        ...
        "Pokémon with this ability" to "Pokémon avec ce talent",
        "Normal" to "Normal",
        "Hidden" to "Caché",
        "No Pokémon has this ability" to "Aucun Pokémon ne possède ce talent",
        "Clear" to "Clear",
        "\u2726 Ability Search \u2726" to "\u2726 Recherche de Talents \u2726",
        "No ability found" to "Aucun talent trouvé",
        "Items" to "Objets",
        "\u2726 Item Search \u2726" to "\u2726 Recherche d'Objets \u2726",
        "No item found" to "Aucun objet trouvé",
        ...
        "Congrats!" to "Bravo !",
        "All hunts completed!" to "Toutes les chasses termin\u00e9es !",
        "Reset" to "Défaut",
        "Icon+" to "Icône+",
        "Position" to "Position",
        "Hunt" to "Chasse",
        "All types" to "Tous les types",
        "Pokédex (#)" to "Pokédex (#)",
        "Size" to "Taille",
        "Small" to "Petit",
        "Normal" to "Normal",
